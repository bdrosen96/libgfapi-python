...
glfs_new = gfapi_prototype('glfs_new', ctypes.c_void_p, StringType)

glfs_set_volfile_server = gfapi_prototype('glfs_set_volfile_server', ctypes.c_int,
                                          ctypes.c_void_p,
                                          StringType,
                                          StringType,
                                          ctypes.c_int)
